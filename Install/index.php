		...
		<body>
			...
			<section>
				...
				if (isset($_POST['Start_Installation']))
				{
					...
					$bdd->exec("CREATE TABLE `Caranille_Orders` (
					`Order_ID` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
					`Order_Name` VARCHAR(30) NOT NULL,
					`Order_Description` TEXT NOT NULL
					)");
					echo "Table Caranille_Order installée<br />";
				...
				if (isset($_POST['Finish']))
				{
					...
					if (isset($_POST['MMORPG_Name']) && ($_POST['Presentation']) && ($_POST['Pseudo']) && ($_POST['Password']) && ($_POST['Email']))
					{
						...
						if ($Password == $Password_Confirm)
						{
							...
							$bdd->exec("INSERT INTO Caranille_Orders VALUES('', 'Neutre', 'Ordre par défaut')");
							$bdd->exec("INSERT INTO Caranille_Orders VALUES('', 'Ange', 'Les anges sont des gens qui vivent pour aider les autres au prix de leur vie')");
							$bdd->exec("INSERT INTO Caranille_Orders VALUES('', 'Demon', 'Les démons sont des gens peut scrupuleux et qui ont une soif de pouvoir')");
