<?php
	...
	if (isset($_SESSION['ID']))
	{
		if (empty($_POST['Change_Password']) && empty($_POST['Finish']))
		{
			...
			echo "<div class=\"important\">$Character_5</div> : " .htmlspecialchars(addslashes($_SESSION['Strength_Base'])). '<br />';
			echo "<div class=\"important\">$Character_6</div> : " .htmlspecialchars(addslashes($_SESSION['Magic_Base'])). '<br />';
			echo "<div class=\"important\">$Character_7</div> : " .htmlspecialchars(addslashes($_SESSION['Agility_Base'])). '<br />';
			echo "<div class=\"important\">$Character_8</div> : " .htmlspecialchars(addslashes($_SESSION['Defense_Base'])). '<br />';
			echo "<div class=\"important\">$Character_9</div> : " .htmlspecialchars(addslashes($_SESSION['HP'])). '/' .htmlspecialchars(addslashes($_SESSION['HP_MAX'])). '<br />';
			echo "<div class=\"important\">$Character_10</div> : " .htmlspecialchars(addslashes($_SESSION['MP'])). '/' .htmlspecialchars(addslashes($_SESSION['MP_MAX'])). '<br />';
